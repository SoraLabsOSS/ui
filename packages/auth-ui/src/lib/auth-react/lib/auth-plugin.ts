...
export type { AuthPluginViewPaths } from "@workspace/auth-ui/lib/auth-core";
...
export interface AuthPluginComponents {
...
export interface AuthPluginViews<TAuthViewProps, TSettingsViewProps> {
...
export interface AuthPluginFallbackViews<TAuthViewProps> {
  auth?: {
