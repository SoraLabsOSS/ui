...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: This visual input wrapper groups controls without fieldset semantics.
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: Clicking addon whitespace forwards focus to its input; nested buttons keep their own action.
    // biome-ignore lint/a11y/useKeyWithClickEvents: The focus affordance is pointer-only; keyboard users can focus the input directly.
    // biome-ignore lint/a11y/useSemanticElements: Addon groups may contain buttons alongside decorative text.
    <div
