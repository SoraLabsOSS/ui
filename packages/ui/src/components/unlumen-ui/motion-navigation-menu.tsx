    ...
    <AnimatePresence custom={context.direction} initial={false}>
      {isOpen && (
        <motion.div
          animate="active"
          className={cn(
            "absolute top-full left-0 z-50 mt-1.5 rounded-md border bg-background/90 p-2 pr-2.5 text-popover-foreground shadow",
            className
          )}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "relative mt-1.5 overflow-hidden rounded-md border bg-background text-popover-foreground shadow backdrop-blur-md",
          className
        )}
        data-slot="navigation-menu-viewport"
        initial={false}
