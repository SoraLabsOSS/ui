...
const switchThumbVariants = cva(
  "pointer-events-none relative flex select-none items-center justify-center rounded-full bg-background shadow-xs ring-0 data-[state=checked]:bg-primary-foreground data-checked:bg-primary-foreground dark:data-[state=checked]:bg-primary-foreground dark:data-[state=unchecked]:bg-foreground dark:data-checked:bg-primary-foreground dark:data-unchecked:bg-foreground [&_svg]:size-3",
  {
    variants: {
      size: {
...
/**
 * An accessible, highly customizable Switch component built with Radix UI and Motion.
