                    ...
                    <TooltipTrigger>
                      <div>
                        <AnimateIcon animateOnHover asChild>
                          <button
                            className="group relative flex aspect-square size-full items-center justify-center rounded-lg p-3.5 ring-foreground transition-[box-shadow] duration-200 hover:ring-2"
