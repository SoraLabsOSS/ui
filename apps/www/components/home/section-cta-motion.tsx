...
export function SectionCta({
  ...
  return (
    <Link
      className="group inline-flex min-w-0 shrink-0 cursor-pointer items-center justify-center whitespace-nowrap font-mono text-sm uppercase outline-none focus-visible:ring-2 focus-visible:ring-accent-pro/50 focus-visible:ring-offset-2"
      href={href}
      onBlur={() => {
        setIsActive(false);
      }}
