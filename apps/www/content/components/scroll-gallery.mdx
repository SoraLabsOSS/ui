...
Ship a full-bleed hero with a three-column info band (prefix, title, link) and large white type. Import `SCROLL_GALLERY_STUDIO_CLASSES` and spread each slot into the matching `*ClassName` prop:
