...
Near-black canvas, uppercase serif copy, and keyword pills tuned for long-form manifesto sections. Pass `TEXT_REVEAL_BOX_STUDIO_CLASSES` into the class slots below:
