...
```tsx
import { ScrollChapters } from "@/components/sora-ui/catalog/scroll-chapters";
...
The drag handle and track provide pointer navigation across chapters while in-flow chapter `content` remains semantic, naturally ordered, and accessible to keyboard users and screen readers.
