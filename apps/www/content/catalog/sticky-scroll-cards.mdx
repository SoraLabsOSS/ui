...
```tsx
import { StickyScrollCards } from "@/components/sora-ui/catalog/sticky-scroll-cards";
...
import {
  ...
  StickyScrollCards,
} from "@/components/sora-ui/catalog/sticky-scroll-cards";
...
All card headings, icons, badges, and descriptions stay in the document flow and remain accessible to screen readers throughout the sequence.
