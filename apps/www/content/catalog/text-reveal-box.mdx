...
```tsx
import { TextRevealBox } from "@/components/sora-ui/catalog/text-reveal-box";
...
import {
  ...
  TextRevealBox,
} from "@/components/sora-ui/catalog/text-reveal-box";
...
All text remains semantic and readable in the DOM throughout the scroll sequence. Screen readers and search engine crawlers access the underlying paragraphs without being affected by the visual highlight animation.
