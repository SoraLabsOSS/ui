...
<TypeTable
  type={{
    ...
    className: {
      description: "Root section class names (merged after variant preset).",
      type: "string",
    },
    variant: {
      description:
        'Visual preset. "studio" applies Deadlock Studios editorial styling; "minimal" is structural-only.',
      type: '"minimal" | "studio"',
      default: "minimal",
    },
    classNames: {
      description:
        "Per-slot class overrides: `images`, `imageFrame`, `image`, `info`, `infoInner`, `prefix`, `prefixText`, `title`, `titleText`, `link`, `linkText`, `track`.",
      type: "ScrollGalleryClassNames",
    },
  }}
/>
