---
title: Text Effect
description: Preset-driven staggered text reveals with blur, fade, slide, and scale animations, powered by Motion. React component.
author:
  name: Axyl
  url: https://github.com/Axyl1410
---

<ComponentPreview name="demo-text-effect" description="Preset-driven staggered text reveals — blur, fade, slide, and scale animations on words and characters." />
