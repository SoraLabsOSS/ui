...
Community components are animated components contributed by the community. Unlike other Sora UI components, they aren’t required to use our primitives, so their APIs may vary and some may offer limited configuration (few or no props).
