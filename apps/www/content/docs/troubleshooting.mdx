...
```bash
bunx --bun shadcn@latest list https://ui.soralabs.studio/r/registry.json
```
...
after the registry on `https://ui.soralabs.studio/r/` is updated. For local
...
If you encounter any other problem, see the [Community](/docs/community) page — [open an issue](https://github.com/SoraLabsOSS/sora-ui-community/issues/new) or ask in [Discussions](https://github.com/SoraLabsOSS/sora-ui-community/discussions/1).
