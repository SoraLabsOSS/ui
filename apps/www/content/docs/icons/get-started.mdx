...
<CodeTabs
  codes={{
    npm: `npx shadcn@latest add @sora/icons-[lucide-icon-name]`,
    pnpm: `pnpm dlx shadcn@latest add @sora/icons-[lucide-icon-name]`,
    yarn: `npx shadcn@latest add @sora/icons-[lucide-icon-name]`,
    bun: `bun x --bun shadcn@latest add @sora/icons-[lucide-icon-name]`,
  }}
/>
