...
<CodeTabs
  codes={{
    pnpm: `pnpm dlx shadcn@latest add @sora/primitives-texts-sliding-number`,
    npm: `npx shadcn@latest add @sora/primitives-texts-sliding-number`,
    yarn: `npx shadcn@latest add @sora/primitives-texts-sliding-number`,
    bun: `bunx --bun shadcn@latest add @sora/primitives-texts-sliding-number`,
  }}
/>
