...
<CodeTabs
  codes={{
    pnpm: `pnpm dlx shadcn@latest add @sora-ui/text-reveal`,
    npm: `npx shadcn@latest add @sora-ui/text-reveal`,
    yarn: `npx shadcn@latest add @sora-ui/text-reveal`,
    bun: `bunx --bun shadcn@latest add @sora-ui/text-reveal`,
  }}
/>
