...
<Callout>
  Use **Sora UI docs MCP** to read documentation. To **install** `@soralabs/*` components with natural language, also configure the [shadcn MCP server](https://ui.shadcn.com/docs/mcp) in the same project.
</Callout>
