...
1. Confirm **{SORA_UI_MCP_SERVER_NAME}** is enabled in **Settings → Tools & MCP**
2. Restart Cursor completely after changing `.cursor/mcp.json`
3. Check **View → Output → MCP** for connection errors
