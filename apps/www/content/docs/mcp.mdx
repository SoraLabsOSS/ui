...
| Server | Role |
| --- | --- |
| **`sora-ui`** | Read docs and browse the catalog — `search_docs`, `get_page`, `list_components`, `get_component_info` |
...
3. **Explicit prompts (most reliable)** — Name Sora UI or the task directly: *“List installable Sora UI components”*, *“Get install info for scroll-gallery”*, *“Add scroll-gallery from @soralabs and use variant=studio”*.
