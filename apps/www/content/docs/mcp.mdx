...
**Claude Code**: Run `claude mcp list` to verify the server is registered. If missing, re-run `claude mcp add --transport http sora-ui https://mcp.soralabs.io.vn/mcp`. Use `claude mcp get sora-ui` to inspect the saved config.
