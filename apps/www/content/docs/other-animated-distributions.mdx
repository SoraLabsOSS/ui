...
- **An MCP server** ([mcp.soralabs.io.vn](https://mcp.soralabs.io.vn)) — AI coding assistants can look up install commands, props, and usage docs directly, instead of guessing from training data.
