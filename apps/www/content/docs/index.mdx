...
Like [shadcn/ui](https://ui.shadcn.com/), **Sora UI is not a typical install‑from‑NPM library**. It’s an open collection you can **copy, modify, and customize** directly in your codebase. This “open code” approach gives you maximum flexibility without wrapper overhead or styling workarounds.

## What’s included

1. **Primitives (animated)**: Building blocks with animation baked in. Authored by Sora UI or ported from popular primitive libraries (Radix UI, Base UI, Headless UI).
