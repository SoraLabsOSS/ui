---
title: Input
description: A shadcn/ui-compatible input with a smooth Motion-powered caret.
author:
  name: Axyl
  url: https://github.com/Axyl1410
intent: Collect a single-line value from the user with familiar shadcn/ui input styling.
role: input
a11yConstraints:
...
<ComponentPreview name="base-input" description="A shadcn/ui-style input with a smooth spring caret." />

## Installation

<ComponentInstallation name="base-input" />

## Usage

```tsx
import { Input } from "@/components/sora-ui/base/input";
...
<ComponentPreview name="demo-input-rtl" description="Base UI Input animates a mirror caret through right-to-left text." />
