...
npx shadcn@latest add @soralabs/text-reveal-blur
```
...
If you're building a site that needs cinematic scroll **without** surrendering control of the code, start with the [docs](/docs), install one primitive, and make it yours.
