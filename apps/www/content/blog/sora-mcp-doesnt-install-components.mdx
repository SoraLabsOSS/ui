...
This repo already leans on Skills for itself — `.agents/skills/nextjs`, `.agents/skills/design-taste-frontend`, packaged instructions that steer an agent while it works *inside* this codebase. So the question comes up: why not package Sora UI's docs and registry the same way, as a Skill, instead of standing up a whole HTTP server for it?
