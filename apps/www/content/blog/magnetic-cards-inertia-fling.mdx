...
Full source is at [/motion/magnetic-cards](/motion/magnetic-cards) — `npx shadcn add` it, it's a plain file in your repo. If the fling feels too aggressive or too tame for your images, `velocityMultiplier` and `rotationVelocityMultiplier` are two number props, not a rebuild.
