...
<video autoPlay className="w-full rounded-md border border-border/60" loop muted playsInline src="https://cdn.soralabs.io.vn/media/demo/magnetic-cards/magetic-card.webm" />
