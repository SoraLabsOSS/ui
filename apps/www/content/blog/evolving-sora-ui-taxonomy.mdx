...
- **Examples:** [`tilt-card`](/motion/tilt-card), [`text-effect`](/motion/text-effect), [`magnetic-cards`](/motion/magnetic-cards), [`highlight`](/motion/highlight), [`rolling-text`](/motion/rolling-text), [`expandable-tabs`](/motion/expandable-tabs).
...
- **Examples:** [`base/button`](/ui/base/button), [`radix/dialog`](/ui/radix/dialog), [`radix/button`](/ui/radix/button), [`base/checkbox`](/ui/base/checkbox).
...
- **Automatic URL Canonicalization:** If you previously bookmarked `/components/sticky-scroll-cards` or `/docs/primitives/tilt-card`, your saved list automatically normalizes the entry to `/catalog/sticky-scroll-cards` and `/docs/motion/tilt-card`.
...
Browse the new [Motion Primitives](/motion), explore the [Catalog](/catalog), or check out the [UI Kit](/ui).
