...
- **Examples:** [`border-trail`](/motion/border-trail), [`text-effect`](/motion/text-effect), [`magnetic-cards`](/motion/magnetic-cards), [`highlight`](/motion/highlight), [`rolling-text`](/motion/rolling-text), [`expandable-tabs`](/motion/expandable-tabs).
