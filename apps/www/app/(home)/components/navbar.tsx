...
export function Navbar({
  ...
  return (
    ...
    >
      ...
      {/* biome-ignore lint/a11y/useKeyWithClickEvents: Backdrop click closes menu */}
      <div className="nav__bg" data-nav-toggle="close" onClick={onCloseMenu} />
          ...
          <div className="nav-bar">
            ...
            <div className="nav-bar__top" data-nav-bar-height="">
              ...
              <div className="nav-bar__menu">
                {/* biome-ignore lint/a11y/useKeyWithClickEvents: Interactive menu toggle */}
                <div
                  className="nav-menu"
