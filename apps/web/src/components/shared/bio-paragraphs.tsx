...
export function BioParagraphs({
  ...
  const p = `${textClassName} leading-[1.75]`;

  return (
    <div className="flex flex-col gap-4.5">
      <p className={p}>Hi. Hello. Hola.</p>
      <p className={p}>
        ↪ I&apos;m Axyl, a developer with 2+ years of experience working at the{" "}
        <DecoderMark>
      ...
      <p className={p}>
        ...
        <DecoderMark>
          distributed and remote-first teams across industries and disciplines.
        </DecoderMark>{" "}
      ...
      <p className={p}>
        ...
        <DecoderMark>remote-first, cross-functional environments.</DecoderMark>{" "}
