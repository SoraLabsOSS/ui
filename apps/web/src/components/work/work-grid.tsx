        ...
        project.comingSoon ? (
          ...
          >
            ...
            <div className="flex items-center justify-between gap-3 pt-2.5 pb-1 max-sm:px-4 max-sm:py-3.5">
              <span className="text-[11px] text-white uppercase tracking-[0.06em]">
                {String(index + 1).padStart(2, "0")}/ {project.title}
              </span>
              <span className="hidden whitespace-nowrap text-[#555] text-[10px] uppercase tracking-[0.04em] max-sm:block">
                Coming soon
              </span>
            </div>
          </div>
